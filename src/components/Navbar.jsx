    ...
    <nav className='shrink-0 border-b border-gray-200 bg-white'>
      <div className='mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex items-center gap-x-4'>
          ...
          <Link
            href={'/create'}
            className='rounded-md bg-[--primary-color] px-3 py-2 text-sm font-semibold text-white shadow-sm duration-300 hover:bg-teal-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600'
          >
            New Post
          </Link>
        </div>
